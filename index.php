...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div
        ...
        <div class="row gy-5 justify-content-between">
          <div
            ...
            <h2>
              <span>Welcome to </span><span class="accent">LinGrow</span>
            </h2>
            <p>
          ...
          <div class="row gy-4 mt-5">
            <div class="col-xl-3 col-md-6">
              <div class="icon-box">
                ...
                <h4 class="title">
                  <a href="" class="stretched-link">Online Course</a>
                </h4>
              </div>
            </div>
            <!--End Icon Box -->
              ...
              <div class="icon-box">
                <img
                  ...
                  style="
                    ...
                    " />
                <h4 class="title">
                  <a href="" class="stretched-link">Offline Course</a>
                </h4>
              </div>
            </div>
            <!--End Icon Box -->
              ...
              <div class="icon-box">
                <img
                  ...
                  style="
                    ...
                    " />
                <h4 class="title">
                  <a href="" class="stretched-link">Kids Course</a>
                </h4>
              </div>
            </div>
            <!--End Icon Box -->
              ...
              <div class="icon-box">
                <img
                  ...
                  style="
                    ...
                    " />
                <h4 class="title">
                  <a href="" class="stretched-link">Skill Upgrade</a>
                </h4>
              </div>
            </div>
            <!--End Icon Box -->
    ...
    <!-- Language Section -->
    <section id="lang" class="pricing section">
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Language</h2>
        <p>
        ...
        <div class="row g-4">
          <div class="col-lg-4">
            <div class="pricing-item">
              <h3>Beginnner Class</h3>
              <div class="icon">
                <i class="bi bi-box"></i>
              </div>
              <h4><sup>Rp.</sup>99.000<span> / month</span></h4>
              <ul>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Our beginner class is perfect for those with little to no
                    prior experience.</span>
                </li>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Learn essential vocabulary, basic grammar, and everyday
                    phrases.</span>
                </li>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Practice speaking in a comfortable and supportive
                    environment.</span>
                </li>
                <!-- <li class="na">
                    <i class="bi bi-x"></i>
          ...
          <div class="col-lg-4">
            <div class="pricing-item featured">
              ...
              <h4><sup>Rp.</sup>299.000<span> / month</span></h4>
              <ul>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Our expert class challenges you to achieve near-native
                    fluency and cultural understanding.</span>
                </li>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Engage in more complex conversations and express yourself
                    with greater clarity.</span>
                </li>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Explore a wider range of topics and delve into the
                    nuances of the language.</span>
                </li>
                <!-- <li>
                    <i class="bi bi-check"></i>
                    <span>Pharetra massa massa ultricies</span>
          ...
          <div class="col-lg-4">
            <div class="pricing-item">
              ...
              <h4><sup>Rp.</sup>499.000<span> / month</span></h4>
              <ul>
                <li>
                  <i class="bi bi-check"></i>
                  <span>Our expert class challenges you to achieve near-native
                ...
                <li>
                  <i class="bi bi-check"></i>
                  <span>Perfect your pronunciation, master complex grammar
                ...
                <li>
                  <i class="bi bi-check"></i>
                  <span>repare for advanced language exams, study abroad, or
                    pursue professional opportunities that require high-level
