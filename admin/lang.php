    ...
    <div class="row">
      <div
        ...
        <div
          ...
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">LinGrow</h5>
            <button
              type="button"
              class="btn-close"
          ...
          <div
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="lang.php">
                <svg class="bi">
                  <use xlink:href="#cart" />
                </svg>
                Language
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <form method="post" class="">
          <label for="LangName" class="fw-semibold my-2">Add Language</label>
          <input
            type="text"
          ...
          <input type="submit" name="addLang" class="btn btn-primary mt-2 mb-5 col-md-6" value="Add Language" />
        </form>
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              <th scope="col">id</th>
              <th scope="col">Name Language</th>
            </tr>
          </thead>
          <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['nama_lang'] . "</td>";

                echo "<td><button class='btn btn-sm btn-outline-danger'>Delete</button></td>";
                echo "</tr>";
              }
            } else {
